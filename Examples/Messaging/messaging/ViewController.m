...
- (void)textFieldDidChange:(NSNotification *)notification {
    ...
    BOOL enableButton = self.inputField.text.length > 0;
    BOOL shouldAnimate = (self.sendButton.enabled != enableButton);

    self.sendButton.enabled = enableButton;
    ...
    if (shouldAnimate) {
        ...
        self.sendButton.hidden = !enableButton;
    }
